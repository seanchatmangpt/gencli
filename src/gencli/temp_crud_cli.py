...
@click.option("--item", type=str, required=True, help="Name of the item")
@click.option("--value", type=str, required=True, help="Value of the item")
...
@click.option("--item", type=str, required=True, help="Name of the item")
@click.option("--new_value", type=str, required=True, help="New value of the item")
